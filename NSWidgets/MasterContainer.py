...
class MasterContainer(QtWidgets.QWidget):
    ...
    def setupUi(self):
        ...
        Form.resize(607, 573)
        #Form.setStyleSheet("background-color: rgb(225, 225, 225);\n"
#"background-color: rgb(234, 234, 234);")
        ...
        #self.L1 = QtWidgets.QWidget(Form)
        ...
        #self.L1.setStyleSheet("background-color: rgb(120, 60, 60);")
        ...
        #self.L2 = QtWidgets.QWidget(Form)
        ...
        #self.T1 = QtWidgets.QWidget(self.T1_NS)
        ...
        #self.T1.setStyleSheet("background-color: rgb(138, 138, 138);")
        ...
        #self.R2 = QtWidgets.QWidget(Form)
        ...
        #self.R2.setStyleSheet("background-color: rgb(148, 148, 148);")
        ...
        #self.R1 = QtWidgets.QWidget(Form)
        ...
        #self.R1.setStyleSheet("background-color: rgb(138, 138, 138);")
